...
class ThreadManager:
    ...
    def __init__(self, max_workers: int = 4):
        ...
        self.executor = ThreadPoolExecutor(
            max_workers=max_workers, thread_name_prefix="PodcastForge"
        )
        ...
        def wrapped_task():
            ...
            try:
                ...
                task_result = TaskResult(
                    task_id=task_id, status=TaskStatus.COMPLETED, result=result, metadata=metadata
                )
...
class UITaskObserver(ITaskObserver):
    ...
    def __init__(self, root_widget):
        ...
        self._callbacks = {"started": [], "progress": [], "completed": [], "failed": []}
