    ...
    def _verify_installation(self):
        ...
        if not self.e2a_path.exists():
            ...
            try:
                ...
                console.print(f"[yellow]git clone https://github.com/DrewThomasson/ebook2audiobook.git {self.e2a_path}[/yellow]")
    
    def generate_audio(self,
                      script: List[Dict],
                      output_path: str,
                      config: PodcastConfig) -> str:
        """
        ...
        try:
            ...
            if not (self.e2a_path / "ebook2audiobook.py").exists():
                console.print("[yellow]⚠️ ebook2audiobook nicht gefunden, verwende TTS direkt[/yellow]")
        ...
        try:
            ...
            for i, entry in enumerate(script):
                ...
                pause = AudioSegment.silent(
                    duration=int(entry.get('pause_after', 0.5) * 1000)
                )
