...
class VoiceLibrary:
    ...
    # Deutsche Stimmen - Erweitert für hochwertige Podcasts
    GERMAN_VOICES = [
        ...
        VoiceProfile(
            ...
            engine="vits",
            tags=["german", "news", "professional", "moderator"],
        ),
        VoiceProfile(
            id="max_de",
            name="Max",
            display_name="Max (Moderator)",
            language="de",
            gender=VoiceGender.MALE,
            age=VoiceAge.ADULT,
            style=VoiceStyle.PROFESSIONAL,
            description="Freundliche Moderator-Stimme, warm und einladend",
            engine="xtts",
            tags=["german", "podcast", "moderator", "freundlich"],
        ),
        VoiceProfile(
            id="stefan_de",
            name="Stefan",
            display_name="Stefan (Dokumentar)",
            language="de",
            gender=VoiceGender.MALE,
            age=VoiceAge.ADULT,
            style=VoiceStyle.DOCUMENTARY,
            description="Seriöse Dokumentar-Stimme, sachlich und informativ",
            engine="xtts",
            tags=["german", "documentary", "informativ", "sachlich"],
        ),
        VoiceProfile(
            id="hans_de",
            name="Hans",
            display_name="Hans (Erzähler)",
            language="de",
            gender=VoiceGender.MALE,
            age=VoiceAge.ELDER,
            style=VoiceStyle.STORYTELLING,
            description="Erfahrener Erzähler, fesselnd und atmosphärisch",
            engine="xtts",
            tags=["german", "storytelling", "narrator", "erfahren"],
        ),
        VoiceProfile(
            id="felix_de",
            name="Felix",
            display_name="Felix (Energetisch)",
            language="de",
            gender=VoiceGender.MALE,
            age=VoiceAge.YOUNG,
            style=VoiceStyle.ENERGETIC,
            description="Jugendliche, energetische Stimme für dynamische Inhalte",
            engine="xtts",
            tags=["german", "energetic", "jung", "dynamisch"],
        ),
        # Professionelle weibliche Stimmen
        VoiceProfile(
            id="anna_de",
            name="Anna",
            display_name="Anna (Expertin)",
            language="de",
            gender=VoiceGender.FEMALE,
            age=VoiceAge.ADULT,
            style=VoiceStyle.PROFESSIONAL,
            description="Kompetente Expertenstimme, klar und überzeugend",
            engine="xtts",
            tags=["german", "expert", "professional", "kompetent"],
        ),
        VoiceProfile(
            id="julia_de",
            name="Julia",
            display_name="Julia (Moderatorin)",
            language="de",
            gender=VoiceGender.FEMALE,
            age=VoiceAge.ADULT,
            style=VoiceStyle.PROFESSIONAL,
            description="Sympathische Moderatorin, warm und zugänglich",
            engine="xtts",
            tags=["german", "moderator", "warm", "zugänglich"],
        ),
        VoiceProfile(
            id="sarah_de",
            name="Sarah",
            display_name="Sarah (News)",
            language="de",
            gender=VoiceGender.FEMALE,
            age=VoiceAge.ADULT,
            style=VoiceStyle.NEWS,
            description="Professionelle Nachrichtensprecherin, sachlich und seriös",
            engine="xtts",
            tags=["german", "news", "professional", "sachlich"],
        ),
        VoiceProfile(
            id="lena_de",
            name="Lena",
            display_name="Lena (Storytelling)",
            language="de",
            gender=VoiceGender.FEMALE,
            age=VoiceAge.ADULT,
            style=VoiceStyle.STORYTELLING,
            description="Erzählerin mit emotionaler Tiefe, fesselnd",
            engine="xtts",
            tags=["german", "storytelling", "emotional", "fesselnd"],
        ),
        VoiceProfile(
            id="marie_de",
            name="Marie",
            display_name="Marie (Entspannt)",
            language="de",
            gender=VoiceGender.FEMALE,
            age=VoiceAge.ADULT,
            style=VoiceStyle.CALM,
            description="Ruhige, beruhigende Stimme für entspannte Inhalte",
            engine="xtts",
            tags=["german", "calm", "entspannt", "meditativ"],
        ),
        VoiceProfile(
            id="lisa_de",
            name="Lisa",
            display_name="Lisa (Lebhaft)",
            language="de",
            gender=VoiceGender.FEMALE,
            age=VoiceAge.YOUNG,
            style=VoiceStyle.ENERGETIC,
            description="Lebhafte, begeisternde Stimme für dynamische Podcasts",
            engine="xtts",
            tags=["german", "energetic", "lebhaft", "begeisternd"],
        ),
    ]
